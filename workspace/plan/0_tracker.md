...
| 10 | Monte Carlo Optimiser & Strategy Lab | Phase 3b (Optuna), DSR/PBO overfitting stats, Phase 4 (MC-scored selection) — Phase 1 (job plumbing) + Phase 2 (MC tab) + Phase 3a (walk-forward job plumbing) + Phase 3c (Optimizer tab UI, fold-level) + Phase 3d (per-trial persistence + trials table UI, fully live-verified incl. 2 real bugs found/fixed by browser-testing) shipped 2026-07-19 | In progress | P1 | 9 (9.1/9.3, shipped) | 2026-07-19 |
