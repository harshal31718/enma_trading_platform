...
| 22 | Industry-standard risk management (Session Risk Governor) | 22.5–22.7 (22.1–22.4 shipped code-side 2026-07-17: governor core, capital integrity gate, portfolio open-risk budget, liq-buffer guard, `risk_breach` webhook, MaxDrawdown/LowProfitPairs protections, risk_check events, shared `services/portfolio_risk.py` + live VaR/CVaR enforcement — pending container test run + live re-verification) | In progress (22.1–22.4 shipped code-side 2026-07-17) | P2 (rest) | 21 (21.1–21.4, shipped) | 2026-07-17 |
