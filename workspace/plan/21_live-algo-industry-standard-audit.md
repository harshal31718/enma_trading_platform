...
| 21.7 | A-11/A-12/A-13/A-14 (risk-inflation logging, data-provenance decision, wick-check dedup, slippage guard) | S each | P2 | **All four shipped 2026-07-17, container-verified 2026-07-17 (301/301 pytest).** A-11/A-14 logging-only; A-12 (`DECISIONS.md` #24 — mainnet-WS live klines for signals) and A-13 (`DECISIONS.md` #25 — skip engine wick-check while brackets armed) code-complete and container-verified, pending live re-verification only. |
